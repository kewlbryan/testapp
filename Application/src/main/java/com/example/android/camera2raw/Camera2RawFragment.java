...
public class Camera2RawFragment extends Fragment
                ...
                synchronized (mCameraStateLock) {
                    ...
                    if (mJpegImageReader == null || mJpegImageReader.getAndRetain() == null) {
                        mJpegImageReader = new RefCountedAutoCloseable<>(
                                ImageReader.newInstance(largestJpeg.getWidth()/16,
                                        largestJpeg.getHeight()/16, ImageFormat.JPEG, /*maxImages*/5));
                    }
    ...
    private void createCameraPreviewSessionLocked() {
        try {
            ...
            //texture.setDefaultBufferSize(mPreviewSize.getWidth(), mPreviewSize.getHeight());
            texture.setDefaultBufferSize(240,320);
                        ...
                        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
                            synchronized (mCameraStateLock) {
                                ...
                                try {
                                    ...
                                    manualControlsLocked(mPreviewRequestBuilder);
    ...
    //Created by Bryan to setup Manual Controls for capture
    private void manualControlsLocked(CaptureRequest.Builder builder) {
        // Enable auto-magical 3A run by camera device
        builder.set(CaptureRequest.CONTROL_MODE,
    ...
    private void captureStillPictureLocked() {
        try {
            ...
            manualControlsLocked(captureBuilder);
